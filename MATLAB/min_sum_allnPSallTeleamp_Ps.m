function [minval, xopt]  = min_sum_allnPSallTeleamp_Ps(alpha, gamma, T, eta, RE, max_n)
...
for k = 1:samples
    fun                 = @(x) (sum_allnPSallTeleamp_Ps(x, alpha, gamma, T, eta, RE, max_n));
...
P1              = sum_allnPSallTeleamp_Ps(x1, alpha, gamma, T, eta, RE, max_n);
P2              = sum_allnPSallTeleamp_Ps(x2, alpha, gamma, T, eta, RE, max_n);
